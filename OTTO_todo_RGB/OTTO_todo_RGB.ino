...
const char programID[]="Otto_APP"; //Each program will have a ID
...
void setup(){
  ...
  pinMode(PIN_SecondButton,INPUT); //A1 - ensure pull-down resistors are used
  pinMode(PIN_ThirdButton,INPUT); //A2 - ensure pull-down resistors are used
